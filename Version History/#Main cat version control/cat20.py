...
def main():
    ...
    for x in range(STEPS):
        ...
        if CATNO > 0:
            print("Cat info:")
            print("How Happy are the cats: ", cathappy)
            print("How Tired are the cats: ", cattiredness)
            print("How Hungry are the cats: ", cathungry)
            print("How Thirsty are the cats: ", catthirst)
            print('\n')
        ...
        if KITTENNO > 0:
            ...
            print("How Hungry are the kittens: ", kittenhungry)
            print("How Thirsty are the kittens: ", kittenthirst)
            print('\n')
